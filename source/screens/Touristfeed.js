        ...
        <TouchableOpacity onPress={() => { navigation.navigate("TouristPlace", { item: item }) }} style={{
            ...
            <View style={{ padding: 10 }}>
                ...
                <View style={{ flexDirection: "row", alignItems: 'center', marginVertical: 5, }}>
                    <Image source={require("../Assests/locationIcon.png")} style={{ width: 15, height: 15 }} />
                    <Text style={{ color: '#6B7280', fontSize: 14, fontWeight: '400', marginLeft: 3 }}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <Text style={{ color: '#6B7280', fontSize: 14, fontWeight: '400' }}>5.0</Text>
                    ...
                    <Image source={require("../Assests/stars.png")} style={{ width: 15, height: 15, marginLeft: 5 }} />
                    <Image source={require("../Assests/stars.png")} style={{ width: 15, height: 15, marginLeft: 5 }} />
                    <Text style={{ color: '#6B7280', fontSize: 14, fontWeight: '400', marginLeft: 10 }}>(128k reviews)</Text>
                </View>

                <View style={{ height: 1.5, width: "auto", backgroundColor: "#E5E7EB", marginTop: 10 }} />

                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 10 }}>
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                        <Image source={require("../Assests/routing.png")} style={{ width: 18, height: 18, marginRight: 5 }} />
                        <Text style={{ color: '#6B7280', fontSize: 14, fontWeight: '400', }}>{item.disTime}</Text>
                    </View>

                    <View style={{ flexDirection: 'row' }}>
                        <TouristTemple color="#9CA3AF" />
                        <Text style={{ color: '#6B7280', fontSize: 14, fontWeight: '400', marginLeft: 5 }}>Temple</Text>
                    </View>
                </View>
            </View>
        </TouchableOpacity>
