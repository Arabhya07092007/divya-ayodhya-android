const data = [
    {
        name: 'Hanuman Garhi',
        address: 'Ram Nagar, Ayodhya, Uttar Pradesh',
...
const ramMandir = {
    ...
    address: 'Sai Nagar, Ayodhya, Uttar Pradesh',
    direction: 'https://maps.app.goo.gl/1QLftGwN67SZ4gwE8',
    timings: '07:00AM - 11:00AM',
    wheelchair: 'true',
    parking: 'true',
    images: [
        'https://media.cnn.com/api/v1/images/stellar/prod/230915082701-04-india-ram-mandir-rebuild.jpg?c=16x9&q=h_833,w_1480,c_fill',
        'https://static.theprint.in/wp-content/uploads/2020/08/Ram-Mandir2.jpg',
    ],
};

export default { data, ramMandir };
